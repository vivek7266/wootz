		...
		with slim.arg_scope(default_arg_scope(is_training)):
			...
			with tf.variable_scope(end_point):
				...
				with tf.variable_scope('Branch_1'):
					branch_1 = slim.conv2d(net, selectdepth(end_point, 96), [1, 1], stride=1, scope='Conv2d_0a_1x1')
					branch_1 = slim.conv2d(branch_1, 128, [3, 3], stride=1, scope='Conv2d_0b_3x3')
				with tf.variable_scope('Branch_2'):
					branch_2 = slim.conv2d(net, selectdepth(end_point, 16), [1, 1], stride=1, scope='Conv2d_0a_1x1')
			...
			with tf.variable_scope(end_point):
				...
				with tf.variable_scope('Branch_1'):
					branch_1 = slim.conv2d(net, selectdepth(end_point, 128), [1, 1], stride=1, scope='Conv2d_0a_1x1')
					branch_1 = slim.conv2d(branch_1, 192, [3, 3], stride=1, scope='Conv2d_0b_3x3')
				with tf.variable_scope('Branch_2'):
					branch_2 = slim.conv2d(net, selectdepth(end_point, 32), [1, 1], stride=1, scope='Conv2d_0a_1x1')
			...
			with tf.variable_scope(end_point):
				...
				with tf.variable_scope('Branch_1'):
					branch_1 = slim.conv2d(net, selectdepth(end_point, 112), [1, 1], stride=1, scope='Conv2d_0a_1x1')
					branch_1 = slim.conv2d(branch_1, 224, [3, 3], stride=1, scope='Conv2d_0b_3x3')
				with tf.variable_scope('Branch_2'):
					branch_2 = slim.conv2d(net, selectdepth(end_point, 24), [1, 1], stride=1, scope='Conv2d_0a_1x1')
			...
			with tf.variable_scope(end_point):
				...
				with tf.variable_scope('Branch_1'):
					branch_1 = slim.conv2d(net, selectdepth(end_point, 144), [1, 1], stride=1, scope='Conv2d_0a_1x1')
			...
			with tf.variable_scope(end_point):
				...
				with tf.variable_scope('Branch_1'):
					branch_1 = slim.conv2d(net, selectdepth(end_point, 160), [1, 1], stride=1, scope='Conv2d_0a_1x1')
			...
			with tf.variable_scope(end_point):
				...
				with tf.variable_scope('Branch_1'):
					branch_1 = slim.conv2d(net, selectdepth(end_point, 192), [1, 1], stride=1, scope='Conv2d_0a_1x1')
					branch_1 = slim.conv2d(branch_1, 384, [3, 3], stride=1, scope='Conv2d_0b_3x3')
				with tf.variable_scope('Branch_2'):
					branch_2 = slim.conv2d(net, selectdepth(end_point, 48), [1, 1], stride=1, scope='Conv2d_0a_1x1')
					branch_2 = slim.conv2d(branch_2, 128, [3, 3], stride=1, scope='Conv2d_0b_3x3')
				with tf.variable_scope('Branch_3'):
					branch_3 = slim.max_pool2d(net, [3, 3],stride=1, scope='MaxPool_0a_3x3')
					branch_3 = slim.conv2d(branch_3, 128, [1, 1], stride=1, scope='Conv2d_0b_1x1')
